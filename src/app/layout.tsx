...
import { createAdsterraPopTelemetryScript } from "@/lib/adsterra-pop-telemetry";
import "./globals.css";

const adsterraPopTelemetry = createAdsterraPopTelemetryScript({
  scriptUrl: "https://globalimmaturelunatic.com/78/27/f3/7827f35f77978da064be19c5413ecbc2.js",
  siteDomain: "farmisland.wiki",
});
const adsterraBannerHtml = `<script data-cfasync="false" type="text/javascript">atOptions = {'key' : 'd42032325269604cce1258fe72123e94','format' : 'iframe','height' : 250,'width' : 300,'params' : {}};</script><script data-cfasync="false" type="text/javascript" src="https://globalimmaturelunatic.com/d42032325269604cce1258fe72123e94/invoke.js"></script>`;
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  ...
  return <html lang="en"><head>
    ...
    <script data-cfasync="false" id="adsterra-pop-telemetry" dangerouslySetInnerHTML={{ __html: adsterraPopTelemetry }} />
