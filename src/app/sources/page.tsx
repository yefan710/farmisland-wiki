...
export default function SourcesPage() { return <>
  ...
  <section className="section"><div className="page-shell content-layout"><div>
    ...
    <article className="content-panel" id="dates"><span className="eyebrow">Freshness and originality</span><h2>Keep the facts, rebuild the answer</h2><p>Game identity, description, and totals were checked Aug 12, 2026. External pages keep their observed or published dates. A later game build can make an older value historical.</p><SourceNote tone="reported" title="External facts are eligible">A competitor table, video frame, or community page can support a recipe, value, Tier, cost, probability, or code. We first extract the fields, then write from the player&apos;s task. We do not reproduce the source&apos;s sentences, heading order, table layout, or images.</SourceNote><div className="next-card"><h3>See a field limit in practice</h3><p>The codes page publishes two dated code rewards while keeping their current activity open.</p><Link className="button button-action" href="/codes">Review code status</Link></div></article>
