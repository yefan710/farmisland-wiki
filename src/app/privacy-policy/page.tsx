...
export default function PrivacyPage() { return <>
  ...
  <section className="section"><div className="page-shell content-panel" id="details"><span className="eyebrow">Effective Aug 12, 2026</span><h2>How the current site works</h2><h3>Information you submit</h3><p>The current version does not include registration, comments, contact forms or a code submission form.</p><h3>Google Analytics</h3><p>This site uses Google Analytics to measure page visits, traffic sources and interactions so the guides can be improved. Analytics loads automatically. Advertising storage, advertising user data and ad personalization are disabled.</p><h3>Public Roblox data</h3><p>The home page may request public game totals from the Roblox game endpoint in your browser. That request is made to Roblox and is subject to Roblox policies. If the request fails, the page shows a dated local snapshot.</p><h3>External links and video players</h3><p>Links to Roblox leave this site. A YouTube player loads only after you choose to play a walkthrough. Those services can apply their own privacy and cookie practices.</p><h3>Hosting records</h3><p>A hosting provider may process ordinary request information needed to deliver a page, such as an IP address, browser details and timestamps.</p><div className="next-card"><h3>Return to the guide</h3><p>Continue without creating an account.</p><Link className="button button-action" href="/">Return home</Link></div></div></section>
</>; }
